...
class AICog(commands.Cog):
    ...
    PERSONA_NAMES: dict[str, str] = {
        ...
        "03_mage": "奇幻法師 (宏大世界、奇幻修辭)",
        "04_manager": "嚴謹主管 (專業幹練、拆解行動)",
        "05_jokester": "幽默樂子人 (歡樂生動、精確吐槽)",
        "06_teacher": "耐心導師 (循序漸進、循循善誘)",
        "07_engineer": "資深工程師 (硬核嚴謹、重視架構)",
        "08_genius": "冷靜天才 (高冷敏銳、直擊核心)",
        "09_friend": "暖心摯友 (真誠同理、溫暖陪伴)",
        "10_detective": "敏銳偵探 (演繹推理、抽絲剝繭)",
        "11_future_ai": "未來科技 (次世代感、前瞻視野)",
        "12_gamer": "遊戲狂熱 (名場面梗、熱血隊友)",
        "13_poet": "文學雅士 (辭藻典雅、詩意優美)",
        "14_buddhist": "淡定禪者 (從容佛系、化解焦慮)",
        "15_consultant": "戰略顧問 (全局視野、長遠決策)",
    }
    ...
    @app_commands.choices(人格=[
        ...
        app_commands.Choice(name="奇幻法師 (宏大世界、奇幻修辭)", value="03_mage"),
        app_commands.Choice(name="嚴謹主管 (專業幹練、拆解行動)", value="04_manager"),
        app_commands.Choice(name="幽默樂子人 (歡樂生動、精確吐槽)", value="05_jokester"),
        app_commands.Choice(name="耐心導師 (循序漸進、循循善誘)", value="06_teacher"),
        app_commands.Choice(name="資深工程師 (硬核嚴謹、重視架構)", value="07_engineer"),
        app_commands.Choice(name="冷靜天才 (高冷敏銳、直擊核心)", value="08_genius"),
        app_commands.Choice(name="暖心摯友 (真誠同理、溫暖陪伴)", value="09_friend"),
        app_commands.Choice(name="敏銳偵探 (演繹推理、抽絲剝繭)", value="10_detective"),
        app_commands.Choice(name="未來科技 (次世代感、前瞻視野)", value="11_future_ai"),
        app_commands.Choice(name="遊戲狂熱 (名場面梗、熱血隊友)", value="12_gamer"),
        app_commands.Choice(name="文學雅士 (辭藻典雅、詩意優美)", value="13_poet"),
        app_commands.Choice(name="淡定禪者 (從容佛系、化解焦慮)", value="14_buddhist"),
        app_commands.Choice(name="戰略顧問 (全局視野、長遠決策)", value="15_consultant"),
    ])
