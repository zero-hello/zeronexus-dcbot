...
FEATURED_MODELS_BY_VENDOR: Dict[str, List[Dict[str, str]]] = {
    ...
    "qwen": [
        ...
        },
        {
            "id": "qwen/qwq-32b",
            "name": "QwQ 32B (推理特化)",
            "features": "開源推理特化模型，專精複雜思考鏈、競賽數學與代碼邏輯。",
        },
        {
            "id": "qwen/qwen-2.5-coder-32b-instruct",
            "name": "Qwen 2.5 Coder 32B",
            "features": "專為代碼生成、重構與程式除錯打造的專業程式模型。",
        },
        {
    ...
    def get_natural_knowledge_context(self, category: Optional[str] = None) -> str:
        ...
        if cat_key and cat_key in FEATURED_MODELS_BY_VENDOR:
            ...
            lines.extend([
                ...
                "3. **嚴格禁止使用生硬的 Markdown 表格、固定模板欄位或枯燥代碼清單拋出資訊**，請使用通順流暢的台灣繁體中文對話。",
            ])
            return "\n".join(lines)
        ...
        lines.extend([
            ...
            "4. **嚴格禁止使用生硬的 Markdown 表格、固定模板欄位或枯燥代碼清單拋出資訊**，請使用通順流暢的台灣繁體中文對話。",
        ])
        return "\n".join(lines)
