    ...
    def _seed_default_models(self) -> None:
        ...
        defaults: List[ModelMetadata] = [
            ...
            ModelMetadata(
                ...
                description="Google 舊版極速模型（已正式退役，平滑轉移至 Gemini 3.1 Flash Lite）。",
            ),
            ModelMetadata(
                ...
                context_window=1048576,
                capabilities={"text", "vision", "tools"},
                description="Google 成熟穩定版極速模型 (OpenRouter 路由)。",
            ),
            ModelMetadata(
            ...
            ModelMetadata(
                ...
                context_window=1048576,
                capabilities={"text", "vision", "tools", "reasoning"},
                description="Google 高性能多模態模型，專精低延遲與複雜指令遵循。",
            ),
            ModelMetadata(
                ...
                context_window=1048576,
                capabilities={"text", "vision", "tools", "reasoning"},
                description="Google 旗艦級思考模型，擅長深度分析與代碼審查。",
            ),
            ModelMetadata(
            ...
            ModelMetadata(
                ...
                context_window=1048576,
                capabilities={"text"},
                description="輕量化極速模型（已正式退役，平滑轉移至 Gemini 3.1 Flash Lite）。",
            ),
            ModelMetadata(
                ...
                description="Google 免費百萬上下文極速模型。",
            ),
