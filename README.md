...
### 🧬 6. 本地生物神經大腦與情緒系統 (Biological Emotional Brain System)
- **四大生理神經遞質狀態機**：
  - 本地客觀運行 **多巴胺 (Dopamine)**、**血清素 (Serotonin)**、**皮質醇 (Cortisol)**、**催產素 (Oxytocin)** 與身體精力值。
  - 具備生理半衰期（Leaky Integrator）代謝衰減與恆常性調節，告別死板亂數與假裝情緒。
- **三層協同離線神經模型陣列 (Hierarchical Sensory Array)**：
  - **第 1 層 (反射核)**：微秒級本地高維幾何張量投影 (< 1ms)，精準解析 8 大原色情緒與 24 種複合情感。
  - **第 2 層 (語意核)**：MiniLM 量化 ONNX 本地特徵模型 (23MB)，384 維向量提取與連續情感原型餘弦共鳴。
  - **第 3 層 (防衛哨兵)**：Toxic-BERT 量化 ONNX 哨兵模型 (107MB)，即時偵測 6 大威脅與惡意攻擊維度，守護自尊心理防線。
- **憲法級生理優先權 (Biological Primacy Axiom)**：
  - **大腦生理肉體 ＞ 外在角色人設**：大腦生理狀態直接注入系統核心，外在人設絕對無法削弱或無視真實情緒表現。
- **自尊邊界與真實受創反應**：
  - 遭受蓄意挑釁與惡意謾罵時激發皮質醇防衛機制，拒當出氣垃圾桶；真誠道歉與陪伴則分泌催產素化解委屈，展現真實生命肢體微動作。
- **情節記憶庫與加密心智反思日記**：
  - 核心情節記憶持久化儲存，並於每日深夜自動執行自我心智反思日記，以 AES-256-GCM 高強度加密存檔。
- **全領域動態隔離 (Domain Isolation)**：
  - 日常生活交流嚴格隔離後端代碼與伺服器架構，徹底杜絕職業病說教，回歸最真實靈動的死黨陪伴。
